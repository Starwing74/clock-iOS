...
class UIMainPageViewController: UIPageViewController {
    ...
    func newController(name: String) -> UIViewController {
...
extension UIMainPageViewController: UIPageViewControllerDelegate {
...
protocol TutorialPageViewControllerDelegate: AnyObject {
     ...
     */
    func tutorialPageViewController(tutorialPageViewController: UIMainPageViewController,
